...
linP_int* createProgByShape(int/*n_var*/,int/*n_constraints*/,int/*n_decision*/,int) ;
linP_int* createProgByTab(int/*n_var*/,int/*n_constraints*/,int/*n_dec*/,int*/*z*/,int**/*prog*/,int) ;
